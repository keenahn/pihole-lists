...
blackListFile='./black.list'
blacklist='./blacklist.txt'

# Get the list from the GitHub
curl 'https://raw.githubusercontent.com/kboghdady/youTube_ads_4_pi-hole/master/black.list'\
> $blacklist
...
curl 'https://raw.githubusercontent.com/kboghdady/youTube_ads_4_pi-hole/master/crowed_list.txt'\
>>$blackListFile
